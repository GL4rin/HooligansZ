...
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("med").addItemEntry(<weapons_of_the_apocalypse:cloth>, 1, 5,[Functions.setCount(0, 1)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("med").addItemEntry(<weapons_of_the_apocalypse:bandage>, 1, 5,[Functions.setCount(0, 1)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("med").addItemEntry(<weapons_of_the_apocalypse:stimpack>, 1, 5,[Functions.setCount(0, 1)], []);
...
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<toughasnails:canteen>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<toughasnails:purified_water_bottle>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<toughasnails:fruit_juice>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<realistictorches:matchbox>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<extratan:apple_juice>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<extratan:lemonade>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<extratan:orange_juice>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:mre>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:sardines>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:cannedfood>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:emptycan>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:foodbag>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:glue>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:ducttape>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:canneddogfood>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:vodka>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:bottlecap>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:wastelandkebab>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:beer>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:sunsetsarsparilla>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:wastelandjelly>, 1, 5,[Functions.setCount(0, 2)], []);
LootTweaker.getTable("minecraft:chests/simple_dungeon").getPool("food").addItemEntry(<weapons_of_the_apocalypse:nails>, 1, 5,[Functions.setCount(0, 2)], []);